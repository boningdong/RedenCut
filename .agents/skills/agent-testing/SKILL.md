---
name: agent-testing
description: Use when completing a user-visible PodCut feature or behavior fix, or when asked to exercise PodCut through its Docker MCP harness. Not for unrelated apps or documentation-only changes.
---
