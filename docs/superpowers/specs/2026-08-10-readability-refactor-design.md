...
Make the PodCut repository easier for a human to read, navigate, and safely change while preserving all observable behavior.
...
- Any examples added to coding standards must come from PodCut and accurately represent its current code.
