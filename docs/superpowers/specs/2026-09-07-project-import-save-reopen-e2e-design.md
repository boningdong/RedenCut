...
Prove that importing `mandarin-short-female.wav`, saving a project, fully restarting Podcut and reopening the saved project preserves the imported audio and restores the visible track and waveform.
...
Derive expected source duration from independent FFprobe inspection, not from Podcut's own imported metadata.
