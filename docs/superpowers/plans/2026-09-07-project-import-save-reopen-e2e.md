...
Interfaces: Main methods choose import/save/open/dirty/export; Runtime exposes `prepareDialog` using existing generation guards and operation queue; MCP exposes `podcut_prepare_dialog`.
