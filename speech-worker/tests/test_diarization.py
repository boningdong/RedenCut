...
from podcut_speech_worker.diarization import diarize, normalize_turns
...
class DiarizationTest(unittest.TestCase):
    ...
    @patch("podcut_speech_worker.diarization.run_pyannote")
    @patch("podcut_speech_worker.diarization.load_manifest_model")
