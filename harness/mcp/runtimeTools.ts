...
export const runtimeTools = [
  ...
  },
  {
    ...
    readOnly: false,
    description:
      'Start one isolated RedenCut run from the current built application. Does not install dependencies or build implicitly. Returns runId and generation. Take browser_snapshot before UI actions. Prepare import/open/save/export dialog replies with redencut_prepare_dialog before clicking. Dirty-project confirmation is unsupported.',
  },
  {
  ...
  },
  {
    ...
    readOnly: false,
    description:
      'Close the identified application, flush evidence and preserve run files. Requires settled work and saved edits or explicit discardUnsaved. Does not affect ordinary RedenCut instances.',
  },
  {
    name: 'redencut_read_diagnostics',
