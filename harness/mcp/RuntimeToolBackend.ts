    ...
    try {
      ...
      return {
        ...
        structuredContent: {
          ...
          recovery:
            'Inspect podcut_status; do not automatically replay mutations. Use the current identity and a fresh browser_snapshot after restart.',
        },
      }
    }
  }
      ...
      .map((tool): Tool => {
        ...
        return {
          ...
          inputSchema: {
            ...
            properties: {
              ...properties,
              runId: { type: 'string', description: 'Current runId from podcut_start/status.' },
              generation: {
                type: 'integer',
                minimum: 1,
